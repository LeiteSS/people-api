package lab.aulaDIO.personApi.controller;
...
import static lab.aulaDIO.personApi.utils.PersonUtils.createFakeDTO;
import static lab.aulaDIO.personApi.utils.PersonUtils.asJsonString;
...
public class PersonControllerTest {
    ...
    void testWhenGETWithValidIsCalledThenAPersonShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(PEOPLE_API_URL_PATH + "/" + expectedValidId)
                ...
                .andExpect(jsonPath("$.firstName", is("Silas")))
                .andExpect(jsonPath("$.lastName", is("Leite")));
    }
    ...
    void testWhenGETIsCalledThenPeopleListShouldBeReturned() throws Exception {
        ...
        mockMvc.perform(get(PEOPLE_API_URL_PATH)
                ...
                .andExpect(jsonPath("$[0].firstName", is("Silas")))
                .andExpect(jsonPath("$[0].lastName", is("Leite")));
    }
